...
| vim/neovim, nano, emacs, micro, [helix](https://helix-editor.com)                                                                                                                                                                                                                                                                                                                              | opened with hi's config, or yours, through an alias - neovim reads `init.lua`, vim `vimrc`, micro your micro directory's files, helix `config.toml` | yes                       | `_HI_DISABLE_EDITORS`; the files are [SETTINGS.md](SETTINGS.md)'s overlay table |
...
| ------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| powerlevel10k | zsh             | your zsh rc loads the theme (`ZSH_THEME=powerlevel10k/powerlevel10k`, a source of `powerlevel10k.zsh-theme`, or a manager naming `romkatv/powerlevel10k`) _and_ `~/.p10k.zsh` (or `$POWERLEVEL9K_CONFIG_FILE`) exists | as the rc loaded it, else from `~/powerlevel10k`, oh-my-zsh's custom themes, the distro or Homebrew path          | that file, sourced after powerlevel10k                                                                                      |
