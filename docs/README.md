...
| [Packaging](PACKAGING.md)                       | The publishing runbook, the reproducibility contract, verifying a download, the demo GIFs.               |
| [Contributing](CONTRIBUTING.md)                 | The gate, what a review bounces on, what 1.x will not break, push protection, governance.                |
| [OpenSSF improvements](OPENSSF-IMPROVEMENTS.md) | Where the score is capped for one maintainer, and the Best Practices answer sheet.                       |
