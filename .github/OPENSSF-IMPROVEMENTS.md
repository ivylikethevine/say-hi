...
the ledger, and [SECURITY.md#assurance-case](../docs/SECURITY.md#assurance-case) is
...
| ------------------------ | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `dco`                    | M                         | [CONTRIBUTING.md#opening-the-pull-request](../docs/CONTRIBUTING.md#opening-the-pull-request) - DCO in spirit, no `Signed-off-by` required. |
| `governance`             | M                         | [CONTRIBUTING.md#governance](../docs/CONTRIBUTING.md#governance) - one maintainer, BDFL, stated explicitly.                                |
| `code_of_conduct`        | M                         | [CODE_OF_CONDUCT.md](../docs/CODE_OF_CONDUCT.md), reporting address included.                                                              |
| `roles_responsibilities` | M                         | [CONTRIBUTING.md#governance](../docs/CONTRIBUTING.md#governance) + `.github/CODEOWNERS`.                                                   |
...
| `documentation_architecture` | M      | [SETTINGS.md#how-it-works](../docs/SETTINGS.md#how-it-works); [GLOSSARY.md](../docs/GLOSSARY.md).                                                                                                                                       |
...
| Criterion                        | Answer | Evidence                                                                                                                                            |
| -------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `maintenance_or_update`          | M      | Semver, [CONTRIBUTING.md#what-1x-will-not-break](../docs/CONTRIBUTING.md#what-1x-will-not-break); a retiring toggle warns one minor release before it goes. |
| `report_tracker`                 | M      | GitHub issues.                                                                                                                                      |
| `vulnerability_report_credit`    | N/A    | No vulnerabilities resolved in the last 12 months.                                                                                                  |
| `vulnerability_response_process` | M      | [SECURITY.md#reporting-a-vulnerability](../docs/SECURITY.md#reporting-a-vulnerability) - 14-day acknowledgement, 60-day disclosure target.                  |

#### Quality / Coding standards and build

| Criterion                                          | Answer | Evidence                                                                                                                                                                      |
| -------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `coding_standards`                                 | M      | [CONTRIBUTING.md#what-a-review-will-bounce-on](../docs/CONTRIBUTING.md#what-a-review-will-bounce-on) - the Google Shell Style Guide plus this project's deviations.                   |
...
| `build_repeatable`                                 | M      | `packaging-smoke` builds the deb/rpm/apk twice and diffs `SHA256SUMS` for byte-identical output; [PACKAGING.md#reproducibility](../docs/PACKAGING.md#reproducibility).                |
...
| Criterion                                                                          | Answer | Evidence                                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `implement_secure_design`                                                          | M      | [SECURITY.md#assurance-case](../docs/SECURITY.md#assurance-case).                                                                                                                                                                                                                                                                  |
...
| `signed_releases`                                                                  | M      | `SHA256SUMS` signed with minisign, public key in [PACKAGING.md#verifying-a-release-download](../docs/PACKAGING.md#verifying-a-release-download); GPG signs the rpm and the apt/rpm repo metadata; a separate key signs the apk index. Private keys live in Actions secrets, never on the Pages site that distributes the packages. |
...
| `assurance_case`                                                                   | M      | [SECURITY.md#assurance-case](../docs/SECURITY.md#assurance-case).                                                                                                                                                                                                                                                                  |
...
| `require_2FA`                                                                       | M                              | [CONTRIBUTING.md#governance](../docs/CONTRIBUTING.md#governance) states 2FA is enabled on the maintainer account.                                                      |
| `secure_2FA`                                                                        | M _(confirm before answering)_ | TOTP/WebAuthn, not SMS.                                                                                                                                        |
| `code_review_standards`                                                             | M                              | [CONTRIBUTING.md#what-a-review-will-bounce-on](../docs/CONTRIBUTING.md#what-a-review-will-bounce-on) + the required-checks list.                                       |
| `build_reproducible`                                                                | M                              | [PACKAGING.md#reproducibility](../docs/PACKAGING.md#reproducibility); byte-identical rebuild in CI.                                                                    |
...
| `security_review`                                                                   | M                              | [SECURITY.md#assurance-case](../docs/SECURITY.md#assurance-case) is a documented, dated review of the security requirements and boundary.                              |
