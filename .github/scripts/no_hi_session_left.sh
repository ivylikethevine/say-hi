...
# no_hi_session_left.sh [file that must still exist] - ci.yml's macOS
# loopback and windows-e2e.yml's wsl-suites (shard 1) share this: the
# session directory a client leaves under $_HI_HOME's mktemp -d (GLOSSARY:
