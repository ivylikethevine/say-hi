...
- [ ] All new code has test coverage >= 75%
- [ ] All tests green
- [ ] All CI checks green
...
AI usage is allowed on this project, but "[agent] said _______" is not a valid excuse for problems with the final product. see: ([AI Usage](https://github.com/ivylikethevine/say-hi/blob/main/README.md#ai-usage))
